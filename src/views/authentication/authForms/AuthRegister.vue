...
<template>
  <h3 class="text-h3 text-center mb-0">註冊</h3>
  <v-form ref="Regform" lazy-validation action="/dashboards/analytical" class="mt-7 loginForm">
    ...
    <v-btn color="primary" block class="mt-4" variant="flat" size="large" @click="validate()">註冊</v-btn>
    <div class="text-center mt-3">
      <router-link to="/" class="text-primary text-decoration-none">已經有帳號了？</router-link>
    </div>
  </v-form>
</template>
